...
const PREVIOUS_RELEASE_CORE_PACKAGE_SOURCES = [
	"npm:@companion-ai/alpha-hub@0.1.3",
	"npm:pi-subagents@0.40.0",
	"npm:pi-btw@0.4.1",
...
const CURRENT_RELEASE_CORE_PACKAGE_SOURCES = [
	"npm:@companion-ai/alpha-hub@0.1.3",
	"npm:pi-subagents@0.40.0",
	"npm:pi-btw@0.4.1",
	"npm:pi-docparser@4.0.0",
...
export const CORE_PACKAGE_SOURCES = [
	"npm:@companion-ai/alpha-hub@0.1.5",
...
const PREVIOUS_RELEASE_PINNED_CORE_PACKAGE_SOURCES = [
	...PREVIOUS_RELEASE_CORE_PACKAGE_SOURCES,
	...LEGACY_ADJACENT_PACKAGE_SOURCES,
] as const;

const CURRENT_RELEASE_PINNED_CORE_PACKAGE_SOURCES = [
...
const LEGACY_DEFAULT_PACKAGE_SETS = [
	...
	[
		...PREVIOUS_RELEASE_PINNED_CORE_PACKAGE_SOURCES,
	],
	[
		...CURRENT_RELEASE_PINNED_CORE_PACKAGE_SOURCES,
	],
	[
